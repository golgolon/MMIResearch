...
startKeyword = "#MyDepressionLooksLike"

keywords = ["sad", "frustraded", "depression", "unhappy", "anxiety", "OxyContin", "Oxaydo", "OxyCONTIN", "Oxyfast", "Roxicodone",
            ...
            "Brintellix", "Marplan", "Nardil", "Emsam", "Parnate", "Mirtazapine", "Symbyax"]
